                    ...
                    >
                      <div className="flex flex-wrap gap-1.5 mb-1.5">
                        {p.tags.slice(0, 2).map((tag) => (
                          <span
                            key={tag}
                            className="px-1.5 py-0.5 rounded-full group-hover:-translate-y-0.5 transition-transform duration-300"
                            style={{
                              fontSize: ".5rem",
                              fontWeight: 500,
                              letterSpacing: ".06em",
...
/* CSS for project card hover color reveal */
const projectThumbStyle = document.createElement("style");
projectThumbStyle.textContent = `.group:hover .project-thumb { filter: grayscale(0) brightness(1) contrast(1) !important; }`;
