...
export const projects: Project[] = [
  ...
  },
  {
    ...
    overview:
      "Haven Properties asked us to create a digital experience that communicates the feeling of home before a single viewing. We designed an immersive property platform with cinematic imagery, intuitive search, and a seamless inquiry flow.",
    outcomes: [
...
export const zoomToGridData = {
  heroImage:
    "https://images.unsplash.com/photo-1762532265047-e30dafda6481?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMGFyY2hpdGVjdHVyZSUyMGRyYW1hdGljJTIwYmxhY2slMjB3aGl0ZXxlbnwxfHx8fDE3NzE1MDg1MTN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
